...
A key part of our discussion has been about the different types of providers nodes on the network. There are two main categories:

1. Light Nodes **(We Will Update this section soon)**
1. [Service Provider](/protocol/service-provider)
