...
# High-Tier Provider: The Network's Computational Backbone
...
![Image description](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/t2pcogx4lkykr0i0lrpd.png)
...
3. **Staking Requirement:** Following registration, providers are required to stake $SPHN tokens. This stake activates the provider’s bidding engine, allowing them to start submitting bids for new deployments.
